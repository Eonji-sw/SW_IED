...
Servo myservo;
float duty_angle, dist_ema, alpha; // added duty_angle, dist_ema and alpha
...
// initialize USS related variables
  ...
  duty_angle = 550.0; // initialize duty_angle
  alpha = _DIST_ALPHA; // initialize alpha
...
// get a distance reading from the USS
  ...
  dist_ema = alpha * dist_raw + (1 - alpha) * dist_ema; // added EMA equation
